...
class Tenant(TenantMixin):
    """
    This model represents a Tenant, which is a single store on our platform.
...
class Order(models.Model):
    ...
    paid = models.BooleanField(default=False, help_text="Indicates if the order has been successfully paid.")
    ...
    def get_total_cost(self):
        """
        Calculates the total cost of the order by summing up the costs of all items.
        """
